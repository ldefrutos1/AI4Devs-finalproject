...
| UC-04 | Modificar y eliminar árboles del colaborador        | Colaborador     | **Sí**        | Modificación y eliminación de ejemplares: **COLABORADOR** solo los propios; **ADMIN** (generalización de rol) sobre cualquier ficha ([HU-008](../backlog/HU-008-edicion-de-mis-arboles.md)).                                                                                                                                    |
