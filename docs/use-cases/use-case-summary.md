...
| **Proveedor de IA**         | Sistema externo: consulta orientativa de características de especie y chat asistido (MVP); identificación por imagen (futuro).                                                                               |
...
| UC-06 | Consultar asistente IA (chat)                       | Colaborador     | **Sí**        | Interacción conversacional **orientativa** con el asistente desde la edición de ficha (UC-04); hilo en memoria del cliente, sin persistencia en servidor.                                                                                                               |
...
4. **UC-05:** modelado en el diagrama; implementación fuera del MVP (**HU-009** — próxima versión en [backlog.md](../backlog/backlog.md) §3).
